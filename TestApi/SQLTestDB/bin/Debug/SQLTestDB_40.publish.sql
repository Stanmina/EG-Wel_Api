...
GO
PRINT N'Altering Procedure [dbo].[spGetSingleGameDataByName]...';


GO
ALTER PROCEDURE [dbo].[spGetSingleGameDataByName]
	@Name nvarchar(50)
AS
BEGIN
	SELECT [G].[UserDataId], [GameDataId], [HighScore], [LevelsCompleted], [TimePlayed] 
	FROM [dbo].[GameData][G]
