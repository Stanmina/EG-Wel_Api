...
GO
PRINT N'Altering Procedure [dbo].[spGetAllUserData]...';
...
AS
BEGIN
	SELECT [U].[UserDataId], [U].[Name], [U].[Alias], [G].[UserDataId], [G].[HighScore], [G].[LevelsCompleted], [G].[TimePlayed]
	FROM UserData U
	JOIN GameData G ON U.UserDataId = G.UserDataId
	ORDER BY HighScore DESC, TimePlayed;
END
GO
