...
GO
PRINT N'Altering Procedure [dbo].[spGetSingleUserDataByName]...';


GO
ALTER PROCEDURE [dbo].[spGetSingleUserDataByName]
	@name nvarchar(50)
AS
BEGIN
	SELECT [G].[HighScore], [G].[LevelsCompleted], [G].[TimePlayed] 
	FROM [dbo].[GameData][G]
...
AS
BEGIN
	SELECT [GameDataId], [UserDataId], [HighScore], [LevelsCompleted], [TimePlayed] 
	FROM [dbo].[GameData];
END
GO
